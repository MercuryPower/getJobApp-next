...
import {GET_CITIES, GET_PROFESSIONS, GET_SKILLS, GET_TYPES_OF_EMPLOY} from "@/url/urls";
const Page = () => {
            ...
            <FormProvider {...form}>
                <form className={'space-y-8'} onSubmit={form.handleSubmit(onSubmit)}>
                    <div className={'flex self-center '}>
                        ...
                        <FormLabel className={'flex justify-center p-2 text-2xl font-bold'}>Создание новой резюме</FormLabel>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type={'text'} placeholder="@gitHub репозиторий или иные источники" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
