        ...
        <header className={'flex justify-around bg-gray-950 drop-shadow '}>
            <div className={'flex'}>
                <div className={'w-159 flex ml-4 self-center flex-col p-1 '}>
                    <div className={'flex m-1 '}>
                        <button className={'w-48 text-center rounded bg-inherit text-white border p-2 hover:opacity-70 transition'}>Соискателям</button>
                    </div>
            ...
            <div className={'flex text-white self-center justify-center'}>
                    ...
                    <button className={'flex border-black p-2 rounded text-white font-bold hover:opacity-70 transition'}>
                        <svg className={'mr-2 self-center'} width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_128_115)">
                                <path d="M6.75261 0.463536L5.05209 3.91145L1.2474 4.46614C0.565106 4.5651 0.291669 5.40624 0.786461 5.88802L3.53906 8.57031L2.88802 12.3594C2.77084 13.0443 3.49219 13.5573 4.09636 13.237L7.5 11.4479L10.9036 13.237C11.5078 13.5547 12.2292 13.0443 12.112 12.3594L11.4609 8.57031L14.2135 5.88802C14.7083 5.40624 14.4349 4.5651 13.7526 4.46614L9.94792 3.91145L8.2474 0.463536C7.94271 -0.151047 7.0599 -0.15886 6.75261 0.463536Z" fill="white"/>
                            </g>
                            <defs>
                ...
                <div className={'ml-9 '}>
                    <button className={'flex border-black p-2 rounded text-white font-bold hover:opacity-70 transition   '}>
                        Еще
                        <svg className={'ml-2 self-center'} width="12" height="7" viewBox="0 0 12 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1.5 1.125L6 5.875L10.5 1.125" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </button>
