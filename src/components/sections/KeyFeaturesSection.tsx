...
const KeyFeaturesSection = () => {
    return (
        <section>
            <div className={'flex justify-center gap-12 self-center lg:flex-row md:flex-col sm:flex-col flex-col'}>
                <div className={'bg-green-600  lg:w-80 md:w-full pb-24 h-auto flex pt-24 justify-end flex-col rounded mt-12 shadow '}>
                ...
                <div className={'bg-green-600 lg:w-80 md:w-full  pt-24 pb-24  flex justify-center flex-col rounded mt-6 shadow p-4 '}>
                    <div className={'flex flex-col self-center'}>
                        <Image
                ...
                <div className={'bg-green-600 lg:w-80 md:w-full flex pt-24 pb-24 justify-start flex-col rounded shadow p-4 '}>
                    <div className={'flex flex-col self-center'}>
                        <Image
                            src="/update.svg"
                            alt="Logo"
