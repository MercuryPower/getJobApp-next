    ...
    return (
        <div className={'flex justify-center'}>
            <div className={'flex flex-col justify-center '}>
                <h2 className={'font-bold text-center m-2'}>Название вакансии</h2>
                <div className={'flex flex-row justify-items-center relative'}>
                    <Input placeholder={'Например: Frontend-разработчик'} className={'w-96'}/>
                    <Button className={'h-full bg-green-600 rounded-r-2xl cursor-pointer flex   rounded  p-4 absolute right-0 transform self-center '}>
                        <svg className={' self-center '} width="23" height="22" viewBox="0 0 23 22" fill="black" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className={'text-center font-light m-4'}>или</p>
                <h2 className={'font-bold text-center m-2'}>Выберите категорию</h2>
